...
<head>
    ...
    <title>Courier | Overdue Payment Report</title>
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="financeOverduePayment" class="_active"><i class="fa fa-circle-o"></i>
            ...
            <header id="header" class="header">
                ...
                <div class="header-menu">
                    ...
                    <div class="col-sm-7">
                        ...
                        <h6>View Overdue Payment Report</h6>
                    </div> 
                    ...
                    <div class="card-body">
                        <div id="query_div" style="width: 40%;margin-left: 30%;">
                            <form id="queryForm">
                                ...
                                <div class="form-group">
                                    <select class="form-control custom-select" id="pay_method" name="pay_method">
