...
<head>
    ...
    <title>Courier | Add Regional Parcel</title>
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="addRegionalParcel" class="_active"><i class="fa fa-plus"></i>
                            ...
                            <div class="row" style="margin-left: 9%;">
                                <div class="col-4" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label class="label">ID Type</label><br>
                                            <label><input type="radio" name="id_type">&nbsp;Voter's</label>&nbsp;&nbsp;&nbsp;
                                            <label><input type="radio" name="id_type">&nbsp;National</label>&nbsp;&nbsp;&nbsp;
                                            <label><input type="radio" name="id_type">&nbsp;Driver's</label>

                                            <input type="text" name="sender_address" class="form-control" placeholder="ID Number" maxlength="15" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control custom-select" name="regional_sender_origin">
                                ...
                                <div class="col-4" style="margin-left: 10%;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label class="label">ID Type</label><br>
                                            <label><input type="radio" name="consignee_id_type">&nbsp;Voter's</label>&nbsp;&nbsp;&nbsp;
                                            <label><input type="radio" name="consignee_id_type">&nbsp;National</label>&nbsp;&nbsp;&nbsp;
                                            <label><input type="radio" name="consignee_id_type">&nbsp;Driver's</label>

                                            <input type="text" name="recipient_address" class="form-control" placeholder="Recipient's Ghana Card Number" maxlength="15" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control custom-select" name="regional_recipient_destination">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="radioStyle"><input type="radio" name="parcel_type" value="luxury" id="luxury">&nbsp;Luxury</label>&nbsp;&nbsp;
                                                    <label class="radioStyle"><input type="radio" name="parcel_type" value="liquid" id="liquid">&nbsp;Liquid</label>&nbsp;&nbsp;
                                                    <label class="radioStyle"><input type="radio" name="parcel_type" value="solid" id="solid">&nbsp;Solid</label>
                                                </div>
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div id="wayPrintout">
                        <div class="row">
                            <div class="col-6">
                                <div style="background: #d0d3d0;padding: 10px;">
                                    <img src="../images/awa_logo.png" style="width: 50%;height: 40px;">
                                </div>
                            </div>
