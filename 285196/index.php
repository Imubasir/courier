                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="branches" class="_active"><i class="fa fa-arrows-alt"></i>
                ...
                <div class="card" id="userList">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist" style="background: #17a2b8;padding: 15px;margin-top: -3%;">
                          <li class="nav-item">
                            ...
                            aria-selected="true" style="border: none;color: white;" onclick="loadBranch ()">Local Stations</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                            aria-selected="false" style="border: none;color: white;" onclick="loadRegionalBranch()">Regional Stations</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" style="width: 50%;margin-left: 20%;width: 60%;padding: 20px;box-shadow: 2px 2px 9px 1px #efeeee;">
                        <br>
                        <div class="card">
                            <div class="card-title">List of Operating Local Stations</div>
                            <div class="card-body" style="padding: 20px;box-shadow: 2px 2px 9px 1px #efeeee;">
                                <span style="float: right;"><button class="btn btn-sm btn-info" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i> Add Station</button></span>
                                <br>
                                <br>
                                <br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="branch_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Station Code</th>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab" style="width: 50%;margin-left: 20%;width: 60%;padding: 20px;box-shadow: 2px 2px 9px 1px #efeeee;">
                        <br>
                        <div class="card">
                            <div class="card-title">List of Operating Regional Stations</div>
                            <div class="card-body" style="padding: 20px;box-shadow: 2px 2px 9px 1px #efeeee;">
                                <span style="float: right;"><button class="btn btn-sm btn-info" data-toggle="modal" data-target="#addRegionalModal"><i class="fa fa-plus"></i> Add Station</button></span>
                                <br>
                                <br>
                                <br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="regional_branch_table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Station Code</th>
  ...
  <div class="modal-body">
    <form id="addForm">
      <div class="form-group">
          <input type="text" name="branch_name" class="form-control" placeholder="Station Name">
      </div>

      <div class="form-group">
          <input type="text" name="prefix" class="form-control" placeholder="Station Prefix: TL, AC, TK, KM etc">
      </div>
...
<div class="modal-footer">
    ...
    <button onclick="addBranch()" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Save</button>
...
<!-- Add Regional Modal -->
<div class="modal fade" id="addRegionalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Add Regional Station</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
      </button>
  </div>
  <div class="modal-body">
    <form id="addRegionalForm">
      <div class="form-group">
          <input type="text" name="regional_branch_name" class="form-control" placeholder="Station Name">
      </div>

      <div class="form-group">
          <input type="text" name="regional_prefix" class="form-control" placeholder="Station Prefix: GH, NIG, SA etc">
      </div>
...
<div class="modal-footer">
    <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</button>
    <button onclick="addRegionalBranch()" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Save</button>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    <form id="editForm">
      <div class="form-group">
          <input type="text" name="edit_branch_name" class="form-control" placeholder="Branch Name">
      </div>

      <div class="form-group">
          <input type="text" name="edit_prefix" class="form-control" placeholder="Branch Prefix: TL, AC, TK, KM etc">
      </div>
...
<!-- Edit Regional Modal -->
<div class="modal fade" id="editRegionalModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Edit Regional Branch</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
      </button>
  </div>
  <div class="modal-body">
    <form id="editRegionalForm">
      <div class="form-group">
          <input type="text" name="edit_regional_branch_name" class="form-control" placeholder="Branch Name">
      </div>

      <div class="form-group">
          <input type="text" name="edit_regional_prefix" class="form-control" placeholder="Branch Prefix: TL, AC, TK, KM etc">
      </div>
...
<div class="modal-footer">
    <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal"><i class="fa fa-close"></i> Cancel</button>
    <button id="delRegBtn" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</button>
    <button id="saveRegBtn" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Save</button>
