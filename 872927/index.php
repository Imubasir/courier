...
<head>
    ...
    <title>Courier | View Payments</title>
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="viewPayment" class="_active"><i class="fa fa-dot-circle-o"></i>
                            ...
                            <table class="table table-striped table-hover" id="view_table">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td id="weight" style="font-weight: bold;color: #27c51c !important;font-size: 15px;"></td>
                                        
                                        <td id="amount" style="font-weight: bold;color: #27c51c !important;font-size: 15px;"></td>
                                    </tr>
                                </tfoot>
        ...
        <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            <form id="searchForm">
              ...
              <div class="form-group">
                  <select class="form-control custom-select" name="parcel_group">
                    <option selected value="">Select Parcel Group</option>
