...
<head>
    ...
    <title>Courier | Receive Manifest </title>
    ...
    <aside id="left-panel" class="left-panel">
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="receiveManifest" class="_active"><i class="fa fa-handshake-o"></i>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <div class="card">
                    <div class="card-body" id="manifest_div">
                        <div class="card-title">List of Manifests for Receiving Items</div>
                        <br>
                        <span style="float: right;"><button class="btn btn-sm btn-info" data-toggle="modal" data-target="#searchModal"><i class="fa fa-search"></i> Custom Search</button></span>
                        <br>
                        <br>
                        <br>
                    ...
                    <div id="parcel_div" style="display: none;padding: 10px;">
                        <!-- <span style="float: right;"><button>Go Back</button></span> -->
                        <!-- <br>
                            <br> -->
                            <ul class="nav nav-tabs" id="myTab" role="tablist" style="background: #17a2b8;padding: 15px;margin-top: -3%;">
                              <li class="nav-item">
                                <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
                                aria-selected="true" style="border: none;color: white;" onclick="">Receive Items</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
                                aria-selected="false" style="border: none;color: white;" onclick="fetchOverDue ()">Overdue Items</a>
                            </li>

                            <li class="nav-item" style="margin-left: 60%;">
                                <span class="btn btn-md" onclick="goBack();" style="border: none;color: white;"><i class="fa fa-arrow-left"></i> Go Back</span>
                            </li>
                        ...
                        <div class="tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="receive_tbl">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Code</th>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <br>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="overdue_tbl">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Code</th>
...
<div class="modal-footer">
    ...
    <button onclick="search()" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> Search</button>
