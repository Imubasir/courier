...
<head>
    ...
    <title>Courier | Search Parcel</title>
...
<body>
    ...
    <aside id="left-panel" class="left-panel">
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="searchParcel" class="_active"><i class="fa fa-search"></i>
                            ...
                            <div style="width: 50%;margin-left: 25%;box-shadow: 3px 9px 3px 3px #17a2b81c;padding: 20px;">
                                <form id="searchForm">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="parcelcode" placeholder="Parcel Code">
                                    </div>

                                    <div class="form-group">
                                        <select class="form-control custom-select" name="destination" id="manifest_destination">
                                ...
                                <button class="btn btn-sm btn-success" onclick="search()"><i class="fa fa-search"></i> Search</button>
                            </div>
                        </div>

                        <div id="result_div" style="display: none;">
                            <button class="btn btn-sm btn-danger" onclick="back()"><i class="fa fa-angle-left"></i> Back</button>
                            <br>
                            <br>
      ...
      <div class="modal-footer">
        ...
        <button id="saveResultsBtn" class="btn btn-primary btn-sm">Search</button>
