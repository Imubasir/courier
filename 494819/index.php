...
<head>
    ...
    <title>Courier | View Manifest</title>
    ...
    <aside id="left-panel" class="left-panel">
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="viewManifest" class="_active"><i class="fa fa-tasks"></i>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <div class="card">
                    <div class="card-title">List of Manifests</div>
                    <div class="card-body">
          ...
          <div class="modal-body">
            <form id="searchForm">
              <div class="form-group">
                  <input type="text" name="code" class="form-control" placeholder="Manifest Code">
              </div>
