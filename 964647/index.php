...
<head>
    ...
    <title>Courier | Return Parcel Payments</title>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            <a href="#" class="dropdown-toggle index" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="parcelHome"> <i class="menu-icon fa fa-money"></i>Payments</a>
                            <ul class="sub-menu children dropdown-menu">
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4" style="border-right: 1px solid #dfe0e1;">
                                <!-- <form id="pay_form"> -->
                                    <hr>
                                    <div class="form-group">
                                     <div class="row">
                                        <div class="col-9">
                                            <input type="text" name="parcel_code" class="form-control" placeholder="Enter Parcel Code" style="border: none;border-bottom: 1px solid;background-color: aliceblue;">
                                        </div>
                                        <div class="col-1">
                                ...
                                <form id="pay_form">
                                    <div class="form-group">
                                        ...
                                        <label><input type="radio" name="pay_method" value="cash" id="radioCash">&nbsp;Cash</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        
                                        <label><input type="radio" name="pay_method" value="mobile_money" id="radioMomo">&nbsp;Mobile Money</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        
                                        <label><input type="radio" name="pay_method" value="visa" id="radioVisa">&nbsp;VISA</label>
                                    </div>

                                    <div class="form-group" id="balance_div" style="display: none">
                                        <div class="row">
                                            <div class="col-6">
                                                <input type="text" name="received" id="received" class="form-control" placeholder="Amount Received">
                                            </div>
                                            <div class="col-6">
                                                <label>Change</label>
                                                <h5 id="change"></h5>
                                ...
                                <!-- </form> -->
                                <hr>
                                <button class="btn btn-sm btn-success btn-block" style="box-shadow: 3px 3px 5px 1px #bdc7bd;padding: 10px" id="paymentBtn">Confirm Payment</button>
                            </div>
                            <div class="col-3">

                                <span style="color: #626466;font-size: 15px;font-weight: bold;">Payment Detail</span>
                                <table class="table">
                                    <tr>
                                        <td>Category</td>
                                        <th id="parcel_type"></th>
                                    </tr>

                                    <tr>
                                        <td>Description</td>
                                        <th id="content_descr"></th>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><span style="color: #626466;font-size: 15px;font-weight: bold;">Subtotal</span></td>
                                        <td id="amount" style="color: green;font-weight: bold;"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th><span style="color: #626466;font-size: 15px;font-weight: bold;">Grand Total</span></th>
                                        <th id="t_amount" style="color: green;font-weight: bold;"></th>
                                    </tr>
                                </table>
                            </div>
                        </div>
