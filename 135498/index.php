...
<head>
    ...
    <title>Courier | View Parcel</title>
    ...
    <link id="pagestyle" href="../assets/css/animate.min.css" rel="stylesheet" />
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="viewDetails" class="_active"><i class="fa fa-list"></i>
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="financeViewCompanySent"><i class="fa fa-circle-o"></i>
                                    <a href="../403524/">Company Parcels Report </a>
                                </li>
         ...
         <div class="content mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6>Daily Parcels Registered</h6>
                    <br>
      ...
      <div class="modal-body">
        <form id="searchForm">
          <div class="form-group">
              <input type="text" name="code" class="form-control" placeholder="Parcel Code">
          </div>
...
<div class="modal fade" id="details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body" id="printWay">
            <div class="row">
                <div class="col-6">
...
<div class="row">
    ...
    <div class="col-6">
        <div id='qrcode' style='float:center;overflow: hidden;letter-spacing: 5px;'></div>
    </div>
</div>
...
<div class="modal-footer">
    ...
    <button onclick="printout('printWay')" class="btn btn-primary btn-sm"><i class="fa fa-print"></i> Print</button>
</div>
</div>
</div>
</div>
...
<script src="../vendors/sweet-alert-master/resources/js/sweetalert.all.js"></script>
<!-- Tables -->
