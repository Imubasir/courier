...
<!--<![endif]-->
    ...
    <head>
        ...
        <title>Courier | Finance Dashboard</title>
    ...
    <body>
                        ...
                        <li style="line-height: 30px;">
                            ...
                            <li class="menu-item-has-children dropdown keep-open">
                                ...
                                <ul class="sub-menu children dropdown-menu">
                                    ...
                                    <li id="financeDashboard" class="_active"><i class="fa fa-circle-o"></i>
            ...
            <div id="right-panel" class="right-panel">
                ...
                <div class="content mt-3">
                            ...
                            <div class="card">
                              <div class="card-body" style="position: relative;">
                                <div class="data-content">
                                    <div><h6>Daily</h6></div>
                                    <div id="general_daily_parcel" style="color: #eb08e4;font-weight: bold;"></div>
                                </div>
                                <div class="data-icon data-icon-color1"><i class="mdi mdi-database"></i></div>
                                <hr class="divider">
                                <span class="data-meta">Total Parcels Registered</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-3">
                        <div class="card">
                          <div class="card-body" style="position: relative;">
                            <div class="data-content">
                              <div><h6>Weekly</h6></div>
                              <div id="general_weekly_parcel" style="color: #eb08e4;font-weight: bold;"></div>
                          </div>
              ...
              <div class="col-3">
                <div class="card">
                  <div class="card-body" style="position: relative;">
                    <div class="data-content">
                      <div><h6>Monthly</h6></div>
                      <div id="general_monthly_parcel" style="color: #eb08e4;font-weight: bold;"></div>
                  </div>
      ...
      <div class="col-3">
        <div class="card">
          <div class="card-body" style="position: relative;">
            <div class="data-content">
              <div><h6>Yearly</h6></div>
              <div id="general_yearly_parcel" style="color: #eb08e4;font-weight: bold;"></div>
          </div>
    ...
    <div class="col-3">
        <div class="card">
          <div class="card-body" style="position: relative;">
            <div class="data-content">
                <div><h6>Daily</h6></div>
                <div id="general_daily_payment" style="color: red;font-weight: bold;"></div>
            </div>
            <div class="data-icon data-icon-color5"><i class="mdi mdi-database"></i></div>
            <hr class="divider">
            <span class="data-meta">Total Payments Taken</span>
        </div>
    </div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Weekly</h6></div>
          <div id="general_weekly_payment" style="color: red;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color6"><i class="mdi mdi-account-star"></i></div>
      <hr class="divider">
      <span class="data-meta">Total Payments Taken</span>
  </div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Monthly</h6></div>
          <div id="general_monthly_payment" style="color: red;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color7"><i class="mdi mdi-checkbox-multiple-marked-circle-outline"></i></div>
      <hr class="divider">
      <span class="data-meta">Total Payments Taken</span>
  </div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Yearly</h6></div>
          <div id="general_yearly_payment" style="color: red;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color8"><i class="mdi mdi-sync"></i></div>
      <hr class="divider">
      <span class="data-meta">Total Payments Taken</span>
  </div>
</div>
...
<h6 style="border-top: 0.5px solid #0000ff2e;">Station Summary</h6>
<div class="row">
    <div class="col-3">
        <div class="card">
          <div class="card-body" style="position: relative;">
            <div class="data-content">
                <div><h6>Daily</h6></div>
                <div id="accra_daily_parcel" style="color: #eb08e4;font-weight: bold;"></div>
            </div>
            <div class="data-icon data-icon-color9"><i class="mdi mdi-database"></i></div>
            <hr class="divider">
            <span class="data-meta">Parcels Registered - Accra</span>
        </div>
    </div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Daily</h6></div>
          <div id="kumasi_daily_parcel" style="color: #eb08e4;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color10"><i class="mdi mdi-account-star"></i></div>
      <hr class="divider">
      <span class="data-meta">Parcels Registered - Kumasi</span>
  </div>
</div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Daily</h6></div>
          <div id="takoradi_daily_parcel" style="color: #eb08e4;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color11"><i class="mdi mdi-checkbox-multiple-marked-circle-outline"></i></div>
      <hr class="divider">
      <span class="data-meta">Parcels Registered - Takoradi</span>
  </div>
</div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Daily</h6></div>
          <div id="tamale_daily_parcel" style="color: #eb08e4;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color12"><i class="mdi mdi-sync"></i></div>
      <hr class="divider">
      <span class="data-meta">Parcels Registered - Tamale</span>
  </div>
</div>
</div>
</div>
    ...
    <div class="col-3">
        <div class="card">
          <div class="card-body" style="position: relative;">
            <div class="data-content">
                <div><h6>Daily</h6></div>
                <div id="accra_daily_payment" style="color: red;font-weight: bold;"></div>
            </div>
            <div class="data-icon data-icon-color13"><i class="mdi mdi-database"></i></div>
            <hr class="divider">
            <span class="data-meta">Payments Taken - Accra</span>
        </div>
    </div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Daily</h6></div>
          <div id="kumasi_daily_payment" style="color: red;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color14"><i class="mdi mdi-account-star"></i></div>
      <hr class="divider">
      <span class="data-meta">Payments Taken - Kumasi</span>
  </div>
</div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Daily</h6></div>
          <div id="takoradi_daily_payment" style="color: red;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color15"><i class="mdi mdi-checkbox-multiple-marked-circle-outline"></i></div>
      <hr class="divider">
      <span class="data-meta">Payments Taken - Takoradi</span>
  </div>
</div>
</div>
...
<div class="col-3">
    <div class="card">
      <div class="card-body" style="position: relative;">
        <div class="data-content">
          <div><h6>Daily</h6></div>
          <div id="tamale_daily_payment" style="color: red;font-weight: bold;"></div>
      </div>
      <div class="data-icon data-icon-color16"><i class="mdi mdi-sync"></i></div>
      <hr class="divider">
      <span class="data-meta">Payments Taken - Tamale</span>
  </div>
</div>
</div>
</div>
