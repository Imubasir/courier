    ...
    <aside id="left-panel" class="left-panel">
                    ...
                    <li style="line-height: 30px;">
                        ...
                        <li class="menu-item-has-children dropdown keep-open">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li id="customers" class="_active"><i class="fa fa-address-book-o"></i>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <div class="content mt-3">
                <div class="card">
                    <div class="card-title">List of Customers</div>
                    <div class="card-body" style="width: 50%;margin-left: 20%;width: 60%;padding: 20px;box-shadow: 2px 2px 9px 1px #efeeee;">
                        <span style="float: right;"><button class="btn btn-sm btn-info" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i> Add Customer</button></span>
                        <br>
                        <br>
                        <br>
        ...
        <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            <form id="addForm">
              ...
              <div class="form-group">
                  <textarea class="form-control" name="customer_address" placeholder="Customer Address" style="min-height: 70px;"></textarea>
              </div>

              <div class="form-group">
                  <input type="number" class="form-control" name="customer_phone" placeholder="Phone Number">
              </div>
      ...
      <div class="modal-footer">
        ...
        <button onclick="addCustomer()" class="btn btn-primary btn-sm"><i class="fa fa-save"></i> Save</button>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    <form id="editForm">
      <div class="form-group">
          <input type="text" name="edit_customer_name" class="form-control" placeholder="Customer Name">
      </div>

      <div class="form-group">
          <textarea class="form-control" name="edit_customer_address" placeholder="Customer Address" style="min-height: 70px;"></textarea>
      </div>

      <div class="form-group">
          <input type="number" class="form-control" name="edit_customer_phone" placeholder="Phone Number">
      </div>
